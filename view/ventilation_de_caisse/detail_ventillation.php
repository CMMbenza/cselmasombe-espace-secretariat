...
if ($type === 'scolaire') {
  // CORRECTION ICI: Utilisation de DATE(p.dateCreated) au lieu de p.dateCreated
  $sqlE = "
                            ...
                            <div class="table-responsive">
                                <table class="table table-sm align-middle">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td colspan="6"><em>Aucune entrée pour cette date.</em></td>
                                        </tr>
                                        <?php else: ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-danger btn-sm" target="_blank"
                                                    href="../encaissement/api/apercu_recu.php?ordre=<?= (int)$r['id'] ?>">Imprimer</a>
                                                <?php else: ?>
                                                <a class="btn btn-danger btn-sm" target="_blank"
                                                    href="../encaissement/api/apercu_recu_divers.php?ordre=<?= (int)$r['id'] ?>">Imprimer</a>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
                                        <?php endforeach; ?>
                            ...
                            <div class="table-responsive">
                                <table class="table table-sm align-middle">
                                    ...
                                    <tbody>
                                        <?php if (empty($exits)): ?>
                                        <tr>
                                            <td colspan="6"><em>Aucune dépense pour cette date.</em></td>
                                        </tr>
                                        <?php else: ?>
