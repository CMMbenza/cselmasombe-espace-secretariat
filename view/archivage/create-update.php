<?php require_once('service/create.update.service.php'); ?>
                ...
                <div class="content-wrapper">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-sm-12 grid-margin">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title mb-4"><button class="btn btn-primary btn-block enter-btn me-2"
                                            name="" id=""><span class="menu-icon">
                                                <i class="mdi mdi-speedometer"></i>
                                            </span></button>Préparez une annonce à publier</h4>


                                    <div class="row">
                                        <div class="col-lg-12 col-sm-12">
                                            <div class="form-group">
                                                <label for="exampleInputNomEleve" class="form-label">Object :</label>
                                                <input type="text" class="form-control" name="object" id="object"
                                                    placeholder="Entrez l'objectif de l'annonce">
                                            </div>
                                        </div>
                                    </div> 
                                    <div class="row">
                                        <div class="col-lg-12 col-sm-12">
                                            <div class="form-group">
                                                <label for="exampleInputNomEleve" class="form-label">Message</label>
                                                <textarea class="form-control" name="message" id="message" cols="30" rows="50" style="height: 300px"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- <div class="row">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-lg-12">
                                            <label for="exampleInputMénage" class="form-label">Ménage</label>
                                            <div class="d-flex align-items-center">
                                                <select class="form-control" name="" id="">
                                                    <option value="#" disabled selected>Sélectionnez la ménage de
                                                        l'élève</option>
                                        ...
                                        <div class="col-lg-12 col-sm-12">
                                            <div class="form-group">
                                                <label for="exampleInputFraisScolaire" class="form-label">Frais
                                                    scolare</label>
                                                <input type="number" class="form-control" id="exampleInputFraisScolaire"
